<?php
   ...
   if(isset($_GET['id'])){
     ...
     $cname = $row['model_name'];
     $pprice = $row['model_price'];
     $cabout = $row['about_car'];
        ...
        <div class="container-fluid">
         ...
         <!-- Changing .me-auto to .ms-auto shifts it to the right. -->
           <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
             <li class="nav-item">
               <a class="nav-link active" aria-current="page" href="blogHome.php" style="color:#0b83d8;"><b style="font-size:20px;"><</b> Go back to blogs page</a>
             </li>
           </ul>
         </div>
        </div>
      ...
      <div class="row g-0">
        ...
        <div class="col-md-8">
          <div class="card-body">
             ...
             <p class="card-text"><small class="text-body-secondary">author: <?= $aname?></small></p>
         </div>
      </div>
  </div>
</div>
